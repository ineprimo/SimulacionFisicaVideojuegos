...
SprinklerSystem::SprinklerSystem(Vector3 _v, Vector3 _a, Vector4 _c, Vector3 o_, int _med, int _var, int pnum, int cd) 
: ParticleSys(_v, _a, _c, o_, _med, _var), particlenum(pnum), cooldown(cd) {
